<template>
  ...
  <div class="live-header">
    ...
    <ul class="header-notice" v-if="isOwner" :class="{'l-unfold':isFold}">
      ...
      <li>如确认讲师在课堂发布与法律法规相抵触的政治、情色、宗教及其他违规内容，本平台有权直接终止课程，删除课程记录，对全体报名学员实行全额退款，没收讲师所有未结算收入。</li>
      <li>讲师在本产品上发表的全部原创内容（包括但不限于文字、音频、图片等）著作权均归讲者本人所有。未经讲者授权许可，学员不得以任何载体或形式使用讲者的内容，如讲师需要，可以授权本平台进行相关内容维权。
</li>
      <li>发送的图片最大为5M，截图可直接在输入区粘贴发送</li>
      <li>授课过程中，超过1小时未发布新消息，视为授课异常。课程将被下架，对所有学员不可见</li>
