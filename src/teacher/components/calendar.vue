<template>
  <div @click.stop=""  class="calendar" v-show="calendarInfo.show" :style="{'left':x+'px','top':y+'px'}" transition="calendar" transition-mode="out-in">
    <div v-if="type!='time'">
      ...
      select(k1, k2, e) {
        ...
        if (this.range) {
          ...
          if (this.type == 'date') {
            ...
            this.$store.commit('CHANGE_CALENDAR', {show:false})
          }
        }
      },
      // 多选的时候提交
